...
## ann equal weights
run_expt_m2m "m2m_ann_emb_kl_eq_k" 5000 "0,1,2,3,4,5,6,7" "--encoder-latent-embeds --encoder-knn-embeds --encoder-knn-ratio 0.7 --knn-type approx --use-scann --index-trigger 400 --cache-scann --knn-value 5 --agreement-warmup 100 --equal-weights-k --no-kl-till-steps 30000 "
